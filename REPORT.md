...
class hierarchy itself. `UserInterfaceApp` declares two abstract factory methods,
...
(`WindowsDialogApp`, `MacDialogApp`, `GtkDialogApp`) overrides the factory
...
inheritance, and the Creator (`UserInterfaceApp`) still owns real business
